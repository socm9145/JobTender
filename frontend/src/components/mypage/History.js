...
const History = (props) => {
  ...
  return (
    ...
    >
      <CardHeader>
        <Heading size={"md"} fontFamily={"dodum"}>
          {props.date}
        </Heading>
      </CardHeader>
      <CardBody>
        <Box>
          ...
          <Box display={"flex"} justifyContent={"space-around"}>
            <Text fontFamily={"dalserB"} fontSize={"3xl"}>
              {keyword[0]}
            </Text>
            <Text fontFamily={"dalserB"} fontSize={"3xl"}>
              {keyword[1]}
      ...
      <CardFooter>
        <Box width={"100%"}>
          <Text fontFamily={"dalserM"} marginBottom={"2%"}>
            추천 기업
          </Text>
          <Box display={"flex"} justifyContent={"space-between"}>
            <Image
              ...
              width={size}
              height={size}
              src={logo_path + company[0] + ".png"}
            />
            <Image
              borderRadius={borderRadius}
              width={size}
              height={size}
              src={logo_path + company[1] + ".png"}
            />
            <Image
              borderRadius={borderRadius}
              width={size}
              height={size}
              src={logo_path + company[2] + ".png"}
            />
          </Box>
        </Box>
      </CardFooter>
